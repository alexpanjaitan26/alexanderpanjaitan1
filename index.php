...
<head>
    ...
    <title>ALEXANDER PANJAITAN</title>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="parparean3.jpg" alt="balige" style="width:50%;">
        <div class="carousel-caption">
        </div>
      </div>

      <div class="item">
        <img src="parparean4.jpg" alt="Chicago" style="width:50%;">
        <div class="carousel-caption">
        </div>
      </div>
    
      <div class="item">
        <img src="parparean6.jpg" alt="New York" style="width:50%;">
        <div class="carousel-caption">
        </div>
      </div>
